...
None currently open. The death-save turn-skip correction, logging gap, connected Victory/Defeat detection bug, and stable-PC visual treatment (both `CombatantCardHeader.tsx` and `PlayerView.tsx`) are all resolved — see `CHANGELOG.md`.
