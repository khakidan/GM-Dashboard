...
export const CharacterRowSchema = z.preprocess(padRow(12), z.tuple([
  idSchema,                            // [0] id
...
export const NpcRowSchema = z.preprocess(padRow(8), z.tuple([
  idSchema,                            // [0] id
...
export const EncounterCombatantRowSchema = z.preprocess(padRow(5), z.tuple([
  idSchema,                            // [0] id
